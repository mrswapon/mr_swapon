...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&pause=1000&color=4b0e4f&center=true&vCenter=true&width=700&lines=Flutter+Developer+%7C+2.5%2B+Years+Experience;7%2B+Live+Apps+on+App+Store+%27+Play+Store;Clean+Architecture+%7C+Riverpod+%7C+Bloc+%7C+GetX;Firebase+%7C+Socket.IO+%7C+WebRTC+Expert;Available+for+Remote+%26+On-site+Roles+%F0%9F%9A%80" alt="Typing SVG" />
</a>
...
> **Flutter Developer** with **2.5+ years** of experience building and shipping production-ready cross-platform mobile apps for iOS and Android. Delivered **7+ live apps** on the App Store and Google Play Store. Skilled in **Clean Architecture**, **Riverpod/GetX/Bloc**, **REST APIs**, **Firebase**, **Socket.IO**, **WebRTC**, and payment gateways (**Stripe**, **RevenueCat**, **Amar Pay**). Available immediately for **remote or on-site roles**.
